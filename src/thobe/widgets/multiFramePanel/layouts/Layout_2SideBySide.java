...
/**
 * @author Thomas Obenaus
 * @source Layout_LeftRight.java
 * @date 25.04.2010
 */
public class Layout_2SideBySide extends AbstractMultiFrameLayout
{
	...
	{
		this.root = new FrameContainer( new Divider( DividerType.VERTICAL, 0.5 ), frames.get( 0 ), frames.get( 1 ) );
	}
	...
	{
		return "Two panes adjusted side by side.";
	}
